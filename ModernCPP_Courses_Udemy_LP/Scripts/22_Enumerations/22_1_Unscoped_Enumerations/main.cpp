...
//     North,
//     Elm
// }; // Error, can't use North again
// isn't possible with unscoped enums
...
void test1()
{
    ...
    std::cout << "\nDirection " << direction << std::endl;    // Direction 1
    std::cout << direction_to_string(direction) << std::endl; // North

    direction = West;
    std::cout << "\nDirection " << direction << std::endl;    // Direction 8
    ...
    // It's possible to cast things that aren't there !! (like below)
    direction = Direction(100);
    std::cout << "\nDirection " << direction << std::endl;    // Direction 100
...
void test2()
{
    ...
    shopping_list.push_back(Grocery_Item(Helicopter)); // Invalid but lets you push it
    ...
    Milk
    Orange
    Invalid item // comes from "Helicopter"
    Milk // comes from 0
    ==============================
    Valid items: 5
    Invalid items: 1
...
void test3()
{
    ...
    Test Cases and Outputs:
        ...
        Launch state: 5
        User input is not a valid launch state.
