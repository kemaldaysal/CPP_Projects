...
void test1()
{
    ...
    shopping_list.push_back(Grocery_Item(Helicopter)); // Invalid item but lets you push it!!
...
// We're not passing a Player object, just the Player's mode
...
// We're not passing a Player object, just the Player's direction
